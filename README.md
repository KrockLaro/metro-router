Бета-версия, просьба не пользоваться :3

# Маршрутизатор (Metro Router)

Кроссплатформенное приложение для построения маршрутов по электричкам ЦППК/МТППК, МЦД и МЦК. Аналог Metroman и Метро Москвы с поддержкой расписаний, real-time задержек, доступности для маломобильных пассажиров и интерактивной схематичной карты.
...
Право на ключ API Расписания принадлежит компании Яндекс
Право на карту принадлежит OneStreetMap
